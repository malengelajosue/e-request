...
class Comment extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $section=$this->load->view('comment/t_comment_list', $data,true);
    ...
    public function read($id) 
    {
		...
		'idEmployee' => $row->idEmployee,
            ...
            $section=$this->load->view('comment/t_comment_read', $data,true);
             $this->load->view('home/home',['section'=>$section]);
        } else {
    ...
    public function create() 
    {
        ...
        $section=$this->load->view('comment/t_comment_form', $data,true);
         $this->load->view('home/home',['section'=>$section]);
    }
    ...
    public function update_action() 
    {
		...
		'idEmployee' => $this->input->post('idEmployee',TRUE),
            ...
            $this->Comment_model->update($this->input->post('id', TRUE), $data,true);
